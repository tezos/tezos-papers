...
will be flexible enough to accommodate protocols substantially different from
...
to steal recently minted coins and to double spend\cite{centralized}.
...
and other information such as the current block number.
